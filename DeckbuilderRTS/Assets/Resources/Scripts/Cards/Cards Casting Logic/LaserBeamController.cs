...
namespace DeckbuilderRTS
{
    public class LaserBeamController : MonoBehaviour
    {
        ...
        private Vector2 Velocity; // TODO remove velocity?

        public LaserBeamController()
        {
            this.Damage = 20.0f;
            this.Velocity = new Vector2(20.0f, 0.0f);
        }
        ...
        {
            // TODO: if the things touching it are still in the collider, and the charge up has passed, deal damage
            // destroy after a little bit of time to let animation finish
        }
    }
}
